<template>
  <footer>
      ...
      <div class="footer-2">
          <div>
              <p>美团网网购ｄｓｋｆｊｄｓｆｊ经ＩＣＰ正０７０７７９１好经ＩＣＰ咱１０２１１７３９好电子公告服务规则</p>
              <p>广播电视节目制作经营许可证（经）字母０３０８８９好</p>
          </div>
          <span>精工玩干杯１１０１０５０２０２５５５３４好</span>
      </div>
  </footer>
</template>
...
import navList from '../assets/footer-nav-list.js';
export default {
    data(){
        return {
            navList
